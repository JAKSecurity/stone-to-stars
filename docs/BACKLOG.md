...
| RC-004 | Multi-tier gems (Diablo II–inspired faceting + quality progression) | In Progress | P3 | C3 | docs/tickets/RC-004-multi-tier-gems.md |
...
| RC-015 | Implement orbit/lob projectile behaviors | In Progress | P3 | C3 | docs/tickets/RC-015-orbit-lob-behaviors.md |
| RC-016 | Modern age content (mechanized warfare) + hero face/eye fixes | Delivered | P2 | C3 | docs/tickets/RC-016-modern-age.md |
| RC-017 | Exponential per-age progression (economy G=1.75 + fixed-per-age difficulty + run-scene overhaul + early-game balance) | In Progress | P2 | C3 | docs/superpowers/specs/2026-06-08-exponential-economy-design.md |
