...
import { HERO, HERO_IRON, HERO_CLASSICAL, HERO_MEDIEVAL, HERO_RENAISSANCE, HERO_INDUSTRIAL, HERO_MODERN, HERO_SPACE } from './sprites/hero';
...
import { POIS_ART } from './sprites/pois';
...
export const SPRITES: Record<string, SpriteDef> = Object.fromEntries(
  [HERO, HERO_IRON, HERO_CLASSICAL, HERO_MEDIEVAL, HERO_RENAISSANCE, HERO_INDUSTRIAL, HERO_MODERN, HERO_SPACE, ...GEMS, ...PROJECTILES, ...ENEMIES, ...BUILDINGS, ...OBSTACLES, ...POIS_ART, ...FOOD].map((d) => [d.id, d]),
);
