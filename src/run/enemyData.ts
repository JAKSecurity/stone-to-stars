...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  gargoyle: { id: 'gargoyle', name: 'Gargoyle', sprite: 'gargoyle',
    baseHp: 70, speed: 105, contactDamage: 12, drop: 'culture', xp: 7, displaySize: { w: 38, h: 32 }, attack: 'ranged', behavior: 'standoff' },
  dragon: { id: 'dragon', name: 'Dragon', sprite: 'dragon',
    baseHp: 320, speed: 45, contactDamage: 26, drop: 'industry', xp: 34, displaySize: { w: 58, h: 48 }, armor: 1, attack: 'ranged', behavior: 'standoff' },
  musketeer: { id: 'musketeer', name: 'Musketeer', sprite: 'musketeer',
    baseHp: 60, speed: 80, contactDamage: 13, drop: 'science', xp: 7, displaySize: { w: 28, h: 38 }, attack: 'ranged', behavior: 'standoff' },
  ...
  grenadier: { id: 'grenadier', name: 'Grenadier', sprite: 'grenadier',
    baseHp: 85, speed: 100, contactDamage: 15, drop: 'industry', xp: 9, displaySize: { w: 30, h: 38 }, attack: 'ranged', behavior: 'standoff' },
  ...
  rifleman: { id: 'rifleman', name: 'Rifleman', sprite: 'rifleman',
    baseHp: 65, speed: 100, contactDamage: 15, drop: 'industry', xp: 7, displaySize: { w: 26, h: 36 }, attack: 'ranged', behavior: 'standoff' },
  halftrack: { id: 'halftrack', name: 'Halftrack', sprite: 'halftrack',
    baseHp: 240, speed: 50, contactDamage: 26, drop: 'industry', xp: 18, displaySize: { w: 48, h: 34 }, armor: 2, behavior: 'charger' },
