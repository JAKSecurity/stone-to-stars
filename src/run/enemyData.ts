...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  scholar: {
    ...
    displaySize: { w: 20, h: 26 }, attack: 'ranged', behavior: 'standoff',
  },
  cave_dweller: {
  ...
  rock_golem: {
    ...
    displaySize: { w: 38, h: 40 }, armor: 1, attackProfile: 'slash',
  ...
  iron_golem: {
    ...
    displaySize: { w: 48, h: 52 }, armor: 2, attackProfile: 'slash', enrage: true,
  },
  ...
  hoplite: { id: 'hoplite', name: 'Hoplite', sprite: 'hoplite',
    baseHp: 110, speed: 55, contactDamage: 14, drop: 'industry', xp: 9, displaySize: { w: 30, h: 40 }, armor: 1, attackProfile: 'slash' },
  centaur: { id: 'centaur', name: 'Centaur', sprite: 'centaur',
    baseHp: 75, speed: 95, contactDamage: 12, drop: 'industry', xp: 7, displaySize: { w: 42, h: 40 }, attack: 'melee', behavior: 'charger' },
  cyclops: { id: 'cyclops', name: 'Cyclops', sprite: 'cyclops',
    baseHp: 260, speed: 35, contactDamage: 22, drop: 'industry', xp: 28, displaySize: { w: 50, h: 56 }, armor: 2, attackProfile: 'beam', enrage: true },
  ...
  musketeer: { id: 'musketeer', name: 'Musketeer', sprite: 'musketeer',
    baseHp: 60, speed: 80, contactDamage: 13, drop: 'science', xp: 7, displaySize: { w: 28, h: 38 }, attackProfile: 'volley', behavior: 'standoff' },
  ...
  grenadier: { id: 'grenadier', name: 'Grenadier', sprite: 'grenadier',
    baseHp: 85, speed: 100, contactDamage: 15, drop: 'industry', xp: 9, displaySize: { w: 30, h: 38 }, attackProfile: 'mortar', behavior: 'standoff' },
  dreadnought: { id: 'dreadnought', name: 'Dreadnought', sprite: 'dreadnought',
    baseHp: 380, speed: 40, contactDamage: 30, drop: 'industry', xp: 40, displaySize: { w: 56, h: 54 }, armor: 2, attackProfile: 'mortar', enrage: true },
  ...
  steam_tank: { id: 'steam_tank', name: 'Steam Tank', sprite: 'steam_tank',
    baseHp: 200, speed: 45, contactDamage: 22, drop: 'industry', xp: 16, displaySize: { w: 44, h: 36 }, armor: 2, attackProfile: 'mortar' },
  drone: { id: 'drone', name: 'Drone', sprite: 'drone',
    baseHp: 80, speed: 120, contactDamage: 14, drop: 'science', xp: 9, displaySize: { w: 32, h: 26 }, attack: 'ranged', behavior: 'circler' },
  mecha: { id: 'mecha', name: 'Mecha', sprite: 'mecha',
    baseHp: 460, speed: 38, contactDamage: 34, drop: 'industry', xp: 48, displaySize: { w: 60, h: 60 }, armor: 2, attackProfile: 'spawner', spawns: 'drone', enrage: true },
  rifleman: { id: 'rifleman', name: 'Rifleman', sprite: 'rifleman',
    baseHp: 65, speed: 100, contactDamage: 15, drop: 'industry', xp: 7, displaySize: { w: 26, h: 36 }, attackProfile: 'volley', behavior: 'standoff' },
  halftrack: { id: 'halftrack', name: 'Halftrack', sprite: 'halftrack',
    baseHp: 240, speed: 50, contactDamage: 26, drop: 'industry', xp: 18, displaySize: { w: 48, h: 34 }, armor: 2, attackProfile: 'volley', behavior: 'charger' },
  gunship: { id: 'gunship', name: 'Gunship', sprite: 'gunship',
    baseHp: 95, speed: 130, contactDamage: 16, drop: 'science', xp: 10, displaySize: { w: 40, h: 28 }, attackProfile: 'volley', behavior: 'standoff' },
  juggernaut: { id: 'juggernaut', name: 'Juggernaut', sprite: 'juggernaut',
    baseHp: 540, speed: 36, contactDamage: 38, drop: 'industry', xp: 55, displaySize: { w: 62, h: 62 }, armor: 3, attackProfile: 'slash', enrage: true },
