...
export const PASSIVES: Record<string, PassiveDef> = {
  ...
  field_medic:      { id: 'field_medic', name: 'Field Medic', icon: '🩹', maxLevel: 3,
    effectPerLevel: { regenHps: 0.2, damageMult: -0.06 },
    desc: '+0.2 HP/s regen (max 25% HP/run), −6% damage' },
...
export const PASSIVE_FUSIONS: Record<string, PassiveDef> = {
  ...
  'field_medic+oxhide':     { id: 'heartwood', name: 'Heartwood', icon: '🌳', maxLevel: 3,
    effectPerLevel: { maxHp: 25, regenHps: 0.2, fireRateMult: -0.06 },
    desc: '+25 max HP, +0.2 HP/s (25% cap), −6% fire rate' },
