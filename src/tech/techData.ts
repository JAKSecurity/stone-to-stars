...
export const TECHS: Record<string, TechNode> = {
  ...
  combustion: { id:'combustion', name:'Combustion', age:'modern',
    cost:{ industry:110, science:70 }, requires:['assembly_line'],
    unlocksBuilding:'motor_pool', gatesAge:'modern', runBonus:{ weapons:['assault_rifle'] } },
  ballistics: { id:'ballistics', name:'Ballistics', age:'modern',
    cost:{ industry:90, science:60 }, requires:['combustion'],
    unlocksBuilding:'barracks', runBonus:{ weapons:['sniper'] } },
  flight: { id:'flight', name:'Flight', age:'modern',
    cost:{ industry:100, science:90 }, requires:['combustion'],
